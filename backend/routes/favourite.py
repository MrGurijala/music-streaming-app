...
@favorites_router.post("/{user_id}/songs/{song_id}")
def add_favorite(user_id: int, song_id: int, db: Session = Depends(get_db)):
...
@favorites_router.delete("/{user_id}/songs/{song_id}")
